                    ...
                    <React.Fragment key={section.sid}>
                      ...
                      >
                            ...
                            {isAuthenticated && netProfitLoss !== 0 && (
                              <span
                                className={`profit-loss-label ${
                                  netProfitLoss > 0 ? 'profit-text' : 'loss-text'
                                }`}
                              >
                                {netProfitLoss > 0
                        ...
                        {backOdds.map((odd, idx) => (
                          <td
                            key={`back-${idx}`}
                            className={`td-odds back ${idx === 2 ? 'best' : ''} ${
                              odd.odds > 0 ? 'clickable' : ''
                            }`}
                            onClick={() =>
                              odd.odds > 0 &&
                              !isSuspended &&
                        ...
                        {layOdds.map((odd, idx) => (
                          <td
                            key={`lay-${idx}`}
                            className={`td-odds lay ${idx === 0 ? 'best' : ''} ${
                              odd.odds > 0 ? 'clickable' : ''
                            }`}
                            onClick={() =>
                              odd.odds > 0 &&
                ...
                >
                  <div className="card-team-name">
                    ...
                    {isAuthenticated && section1NetPL !== 0 && (
                      <span
                        className={`profit-loss-label ${
                          section1NetPL > 0 ? 'profit-text' : 'loss-text'
                        }`}
                      >
                        {section1NetPL > 0
                ...
                >
                  <div className="card-team-name">
                    ...
                    {isAuthenticated && section2NetPL !== 0 && (
                      <span
                        className={`profit-loss-label ${
                          section2NetPL > 0 ? 'profit-text' : 'loss-text'
                        }`}
                      >
                        {section2NetPL > 0
        ...
        <div className="gd-market-section fancy-section">
          <div className="gd-fancy-tabs">
            <div className="fancy-tab-group">
              ...
              <button
                type="button"
                className={`fancy-tab orange ${
                  activeMainTab === 'sportbook' ? 'active' : ''
                }`}
            ...
            {activeMainTab === 'sportbook' && (
              <div className="fancy-filter-tabs">
                ...
                <button
                  type="button"
                  className={`filter-tab ${
                    activeSportbookTab === 'match' ? 'active' : ''
                  }`}
                ...
                <button
                  type="button"
                  className={`filter-tab ${
                    activeSportbookTab === 'odds/even' ? 'active' : ''
                  }`}
                ...
                <button
                  type="button"
                  className={`filter-tab ${
                    activeSportbookTab === 'batsman' ? 'active' : ''
                  }`}
                ...
                <button
                  type="button"
                  className={`filter-tab ${
                    activeSportbookTab === 'bowler' ? 'active' : ''
                  }`}
                ...
                <button
                  type="button"
                  className={`filter-tab ${
                    activeSportbookTab === 'extra' ? 'active' : ''
                  }`}
                            ...
                            <tr className={isSuspended ? 'suspended' : ''}>
                              <td className="td-fancy-name">
                                ...
                                {isAuthenticated && fancyNetPL !== 0 && (
                                  <span
                                    className={`profit-loss-label ${
                                      fancyNetPL > 0 ? 'profit-text' : 'loss-text'
                                    }`}
                                  >
                                    {fancyNetPL > 0
                              ...
                              <td
                                className={`td-odds no clickable ${
                                  isFancySelected && selectedBet?.type === 'back'
                                    ? 'selected'
                                    : ''
                                }`}
                                onClick={() =>
                              ...
                              <td
                                className={`td-odds yes clickable ${
                                  isFancySelected && selectedBet?.type === 'lay'
                                    ? 'selected'
                                    : ''
                                }`}
                                onClick={() =>
